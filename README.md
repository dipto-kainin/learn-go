...
## Quick curl example (signup)

```bash
curl -X POST http://localhost:8080/auth/signup \
    -H "Content-Type: application/json" \
    -d '{"first_name":"Jane","last_name":"Doe","email":"jane@example.com","password":"password123","phone":"+1000000000","user_type":"USER"}'
````
...
├── helpers/ # Utility functions (JWT, password hashing)
