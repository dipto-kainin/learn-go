    ...
    "paths": {
        "/auth/login": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Login successful with authentication token and user details",
                        "schema": {
        ...
        "/auth/refresh": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Refresh successful with new authentication token and refresh token",
                        "schema": {
        ...
        "/auth/user": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "User profile details (password field will be empty)",
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.BookingCreateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/bookings/{id}/cancel": {
            "put": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid ID or booking already cancelled",
                        "schema": {
                            "$ref": "#/definitions/models.ErrorResponse"
                        }
                    },
        ...
        "/bookings/{id}/check-in": {
            "put": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid ID or booking not pending",
                        "schema": {
                            "$ref": "#/definitions/models.ErrorResponse"
                        }
                    },
        ...
        "/bookings/{id}/min-entry-time": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "New minimum entry time",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "Minimum entry time updated successfully",
                        "schema": {
                            "$ref": "#/definitions/models.SuccessResponse"
                        }
                    },
        ...
        "/foods": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Array of all food items with details",
                        "schema": {
                            "type": "array",
                            "items": {
                    ...
                    "500": {
                        "description": "Database error while fetching foods",
                        "schema": {
                            "$ref": "#/definitions/models.ErrorResponse"
                        }
                    }
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Food created successfully with generated ID",
                        "schema": {
                            "$ref": "#/definitions/models.FoodResponse"
                        }
                    },
                    ...
                    "500": {
                        "description": "Database error while creating food",
                        "schema": {
                            "$ref": "#/definitions/models.ErrorResponse"
                        }
                    }
        ...
        "/foods/{id}": {
                ...
                "parameters": [
                    {
                        ...
                        "description": "Food MongoDB ObjectID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Database error while updating food",
                        "schema": {
                            "$ref": "#/definitions/models.ErrorResponse"
                        }
                    }
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Database error while deleting food",
                        "schema": {
                            "$ref": "#/definitions/models.ErrorResponse"
                        }
                    }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.OrderItemCreateRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.TableCreateRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "models.Order": {
            ...
            "properties": {
                ...
                "food_items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.OrderItemNested"
                    }
                },
                "id": {
                    "type": "string",
        ...
        "models.OrderItemResponse": {
            ...
            "properties": {
                ...
                "message": {
                    "type": "string",
                    "example": "Order item fetched successfully"
                },
                "order_item": {
        ...
        "models.TableResponse": {
            ...
            "properties": {
                ...
                "message": {
                    "type": "string",
                    "example": "Table fetched successfully"
                },
                "table": {
